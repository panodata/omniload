...
def ingest(
    ...
    reshape: Annotated[
        Optional[str],
        typer.Option(
            help="Reshape transform in format '<engine>:<spec>' "
            "(e.g. 'python:my.module:fn'). Restructures nested documents "
            "(flatten/explode/coerce); disables Mongo JSON-array hinting so "
