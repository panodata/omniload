...
sources: LazyRegistry = LazyRegistry(
    {
        "abfss": "dlt_filesystem.source.impl.remote:AzureSource",
        "adjust": "omniload.source.adjust.api:AdjustSource",
        "adls": "dlt_filesystem.source.impl.remote:AzureSource",
        ...
        "az": "dlt_filesystem.source.impl.remote:AzureSource",
        ...
        "file": "dlt_filesystem.source.fsspec.local:LocalFilesystemSource",
        ...
        "http": "dlt_filesystem.source.fsspec.http:HttpFilesystemSource",
        "https": "dlt_filesystem.source.fsspec.http:HttpFilesystemSource",
        "http+webdav": "dlt_filesystem.source.fsspec.webdav:WebdavSource",
        ...
        "msgd": "dlt_filesystem.source.fsspec.sharepoint:SharePointSource",
        "nats+mqb": "omniload.source.mqbridge.api:MqBridgeSource",
        "notion": "omniload.source.notion.api:NotionSource",
        "oci": "dlt_filesystem.source.fsspec.oci:OCISource",
        "onedrive": "dlt_filesystem.source.fsspec.onedrive:OneDriveSource",
        "oss": "dlt_filesystem.source.fsspec.oss:OSSSource",
        ...
        "pulsar+mqb": "omniload.source.mqbridge.api:MqBridgeSource",
        ...
        "redis-streams+mqb": "omniload.source.mqbridge.api:MqBridgeSource",
        ...
        "sharepoint": "dlt_filesystem.source.fsspec.sharepoint:SharePointSource",
        ...
        "smb": "dlt_filesystem.source.fsspec.smb:SMBSource",
        ...
        "websocket+mqb": "omniload.source.mqbridge.api:MqBridgeSource",
...
destinations: LazyRegistry = LazyRegistry(
    {
        "abfss": "dlt_filesystem.target.api:AzureDestination",
        "adls": "dlt_filesystem.target.api:AzureDestination",
        "athena": "omniload.target.athena:AthenaDestination",
        "az": "dlt_filesystem.target.api:AzureDestination",
        ...
        "file": "dlt_filesystem.target.api:LocalFilesystemDestination",
        "file+delta": "omniload.target.deltalake:DeltaLakeDestination",
        "gs": "dlt_filesystem.target.api:GCSDestination",
        ...
        "s3": "dlt_filesystem.target.api:S3Destination",
