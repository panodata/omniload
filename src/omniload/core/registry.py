...
sources: LazyRegistry = LazyRegistry(
    {
        ...
        "gs": "omniload.source.filesystem.api:GCSSource",
        ...
        "s3": "omniload.source.filesystem.api:S3Source",
        "salesforce": "omniload.source.salesforce.api:SalesforceSource",
        "sftp": "omniload.source.filesystem.api:SFTPSource",
...
destinations: LazyRegistry = LazyRegistry(
    {
        ...
        "file": "omniload.target.filesystem.api:LocalFilesystemDestination",
        "gs": "omniload.target.filesystem.api:GCSDestination",
        ...
        "s3": "omniload.target.filesystem.api:S3Destination",
