...
class ArrowMemoryMappedSource:
    ...
    def __init__(self, table_builder=None) -> None:
        if table_builder is None:
            from omniload.src.arrow import memory_mapped_arrow
...
class MongoDbSource:
    ...
    def __init__(self, table_builder=None) -> None:
        if table_builder is None:
            from omniload.src.mongodb import mongodb_collection
...
class NotionSource:
    ...
    def __init__(self, table_builder=None) -> None:
        if table_builder is None:
            from omniload.src.notion import notion_databases
...
class ShopifySource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.shopify import shopify_source
...
class GorgiasSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.gorgias import gorgias_source
...
class GoogleSheetsSource:
    ...
    def __init__(self, table_builder=None) -> None:
        if table_builder is None:
            from omniload.src.google_sheets import google_spreadsheet
...
class ChessSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.chess import source
...
class StripeAnalyticsSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.stripe_analytics.settings import ENDPOINTS
        ...
        if incremental:
            from omniload.src.stripe_analytics import incremental_stripe_source
...
class FacebookAdsSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.facebook_ads import (
            facebook_ads_source,
        ...
        if table in ["campaigns", "ad_sets", "ad_creatives", "ads", "leads"]:
            ...
            from omniload.src.facebook_ads.helpers import (
...
class SlackSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.slack import slack_source
...
class HubspotSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.hubspot import hubspot
...
class AirtableSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.airtable import airtable_source
...
class KlaviyoSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.klaviyo import klaviyo_source
...
class KafkaSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        start_date = kwargs.get("interval_start")
        from omniload.src.kafka import kafka_consumer
        from omniload.src.kafka.helpers import KafkaCredentials, KafkaEventProcessor
        from omniload.src.kafka.model import KafkaDecodingOptions
...
class AppsflyerSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        from omniload.src.appsflyer import appsflyer_source
...
class ZendeskSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.zendesk import zendesk_chat, zendesk_support, zendesk_talk
        from omniload.src.zendesk.helpers.credentials import (
...
class S3Source:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        if endpoint == "read_csv_headless":
            ...
            from omniload.src.filesystem import filesystem
            from omniload.src.filesystem.readers import _read_csv_headless
        ...
        from omniload.src.filesystem import readers
...
class TikTokSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.tiktok_ads import tiktok_source
...
class DoceboSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.docebo import docebo_source
...
class GoogleAnalyticsSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        import omniload.src.google_analytics.helpers as helpers
...
class GitHubSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.github import (
            github_reactions,
            github_repo_events,
            github_stargazers,
        )
...
class AppleAppStoreSource:
    ...
    def init_client(
        ...
        from omniload.src.appstore.client import AppStoreConnectClient
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.appstore import app_store
...
class GoogleAdsSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        if table.startswith("daily:"):
            ...
            from omniload.src.google_ads.reports import Report
        ...
        from omniload.src.google_ads import google_ads
...
class LinkedInAdsSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        if table.startswith("custom:"):
            ...
            from omniload.src.linkedin_ads import linked_in_ads_analytics_source
        ...
        from omniload.src.linkedin_ads import linked_in_ads_source
...
class RedditAdsSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        if table.startswith("custom:"):
            from omniload.src.reddit_ads.helpers import parse_custom_table
        ...
        from omniload.src.reddit_ads import reddit_ads_source
...
class ClickupSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.clickup import clickup_source
...
class AppLovinSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.applovin import applovin_source
...
class ApplovinMaxSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.applovin_max import applovin_max_source
...
class FirefliesSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.fireflies import fireflies_source
...
class SalesforceSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.salesforce import salesforce_source
...
class PersonioSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.personio import personio_source
...
class KinesisSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.kinesis import kinesis_stream
...
class FrankfurterSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.frankfurter import frankfurter_source
        from omniload.src.frankfurter.helpers import validate_currency, validate_dates
...
class FreshdeskSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.freshdesk import freshdesk_source
...
class TrustpilotSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.trustpilot import trustpilot_source
...
class ElasticsearchSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        from omniload.src.elasticsearch import elasticsearch_source
...
class AttioSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.attio import attio_source
...
class SmartsheetSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.smartsheets import smartsheet_source
...
class QuickBooksSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.quickbooks import quickbooks_source
...
class IsocPulseSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.isoc_pulse import pulse_source
...
class WiseSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.wise import wise_source
...
class FundraiseupSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.fundraiseup import fundraiseup_source
...
class AnthropicSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.anthropic import anthropic_source
...
class HttpSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        """
        from omniload.src.http import http_source
...
class MondaySource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.monday import monday_source
...
class MailchimpSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.mailchimp import mailchimp_source
...
class DuneSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.dune import dune_source
...
class AlliumSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.allium import allium_source
...
class CouchbaseSource:
    ...
    def __init__(self, table_builder=None) -> None:
        if table_builder is None:
            from omniload.src.couchbase_source import couchbase_collection
...
class SocrataSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.socrata_source import source
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        if ":" in table:
            ...
            if resource_name in self.STATS_RESOURCES:
                ...
                from omniload.src.snapchat_ads.helpers import parse_stats_table
        ...
        from omniload.src.snapchat_ads import snapchat_ads_source
...
class BruinSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.bruin import bruin_source
...
class PrimerSource:
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        from omniload.src.primer import primer_source
    ...
    def dlt_source(self, uri: str, table: str, **kwargs):
        ...
        for prefix, (source_name, needs_dates) in metrics_sources.items():
            if table.startswith(f"{prefix}:"):
                ...
                from omniload.src import customer_io
        ...
        from omniload.src.customer_io import customer_io_source
