...
class KafkaDecodingOptions:
    ...
    def from_params(
        ...
        if key_type:
            key_type_field = key_type[0]
        if value_type:
            value_type_field = value_type[0]
        return cls(
...
class KafkaEvent:
    ...
    def to_dict(self, options: KafkaDecodingOptions):
        ...
        message_id = digest128(str(self.topic) + str(self.partition) + str(self.key))

        # The standard message layout as defined per dlt and omniload.
        standard_payload = {
