...
| --------------- | ----------- | --------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [companies](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/companies/guide) | hs_object_id | hs_lastmodifieddate | merge | Retrieves information about organizations. |
| [contacts](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/contacts/guide) | hs_object_id | lastmodifieddate | merge | Retrieves information about visitors, potential customers, and leads. |
| [deals](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/deals/guide) | hs_object_id | hs_lastmodifieddate | merge | Retrieves deal records and tracks deal progress. |
...
| [quotes](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/quotes/guide) | hs_object_id | hs_lastmodifieddate | merge | Retrieves price proposals that salespeople can create and send to their contacts. |
...
| [line_items](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/line-items/guide) | hs_object_id | hs_lastmodifieddate | merge | Retrieves individual products or services associated with deals. |
...
| [fees](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/fees/guide) | hs_object_id | hs_lastmodifieddate | merge | Retrieves fee records. |
...
| [owners](https://developers.hubspot.com/docs/api-reference/latest/crm/owners/guide) | id | – | merge | Retrieves HubSpot users who can be assigned to CRM records. |
| [schemas](https://developers.hubspot.com/docs/api-reference/latest/crm/objects/schemas/guide) | id | – | merge | Returns all object schemas that have been defined for your account. |
| [pipelines](https://developers.hubspot.com/docs/api-reference/latest/crm/pipelines/guide) | object_type, pipeline_id | – | replace | Pipeline definitions across all pipelined object types. One row per pipeline. |
| [pipeline_stages](https://developers.hubspot.com/docs/api-reference/latest/crm/pipelines/guide#manage-pipeline-stages) | object_type, pipeline_id, stage_id | – | replace | Stage definitions for each pipeline. One row per stage.|
