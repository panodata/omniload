...
- Make Delta Lake and Iceberg support merge, delete+insert, truncate+insert, and SCD2 strategies.
  https://github.com/bruin-data/ingestr/pull/912
- StarRocks
  https://github.com/bruin-data/ingestr/blob/main/docs/supported-sources/starrocks.md?plain=1
